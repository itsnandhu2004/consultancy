...
<title>Snappy boys | Cameras Details</title>
<!--Bootstrap -->
...
$sql = "SELECT tblcameras.*,tblbrands.BrandName,tblbrands.id as bid  from tblcameras join tblbrands on tblbrands.id=tblcameras.VehiclesBrand where tblcameras.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Camera Model </a></li>
...
<td>Interchangeable Lens Support</td>
...
<?php }} ?>
      ...
      <!--Side-Bar-->
      <!-- In the original page where the button will be placed -->
...
<aside class="col-md-3">
    ...
    <div class="sidebar_widget">
        ...
        <div class="form-group">
            <a href="camera-book-now.php?vhid=<?php echo $vhid; ?>" class="btn btn-danger">Book Now</a>
        </div>
    </div>
</aside>
...
<?php 
$bid=$_SESSION['brndid'];
$sql="SELECT tblcameras.VehiclesTitle,tblbrands.BrandName,tblcameras.PricePerDay,tblcameras.FuelType,tblcameras.ModelYear,tblcameras.id,tblcameras.SeatingCapacity,tblcameras.VehiclesOverview,tblcameras.Vimage1 from tblcameras join tblbrands on tblbrands.id=tblcameras.VehiclesBrand where tblcameras.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
