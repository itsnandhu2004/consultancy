...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Snappy Boys Portal | Admin Post Camera</title>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading custom-heading">Basic Info</div>
										<?php if ($error) { ?>
										...
										<div class="panel-body">
											<form method="post" class=" form form-horizontal" enctype="multipart/form-data">
												<div class="form-group">
													<label class="col-sm-2 control-label">Camera Model<span
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Camera Overview<span
															style="color:red">*</span></label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">Select Lens Type<span
															style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">Resoultion(MP)<span
															style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														Image 5 <span style="color:red">*</span><input type="file"
															name="img5" required>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading custom-heading">Accessories</div>
										<div class="panel-body">
												...
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="powerdoorlocks" name="powerdoorlocks"
															value="1">
														<label for="powerdoorlocks"> Bluetooth </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="antilockbrakingsys"> 4K Recording </label>
													</div>
												</div>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
													<label for="brakeassist"> Touchscreen </label>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<input type="checkbox" id="powersteering" name="powersteering"
															value="1">
														<label for="inlineCheckbox5"> Image Stabilization</label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="driverairbag" name="driverairbag"
															value="1">
														<label for="driverairbag">Weather Sealed</label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="passengerairbag" name="passengerairbag"
															value="1">
														<label for="passengerairbag"> Slow Motion Recording</label>
													</div>
												</div>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
													<label for="powerwindow"> Interchangeable Lens Support </label>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													...
													<button class="btn custom" name="submit" type="submit">Save
														changes</button>
												</div>
											</div>
